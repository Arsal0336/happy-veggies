...
| ------- | ----- | ---- | ---- | ----------- | ----------- | ------------ | -------- | ------ | ----- | -------- | ----- |
| TASK-010 | 0 | Integration | API conventions + error contract | Status codes + error JSON | Shared contract | — | P0 | DONE | Integration | — | Doc 05 §2–4 |
| TASK-011 | 0 | Integration | Auth header conventions | Farmer vs admin bearer | Auth notes | TASK-010 | P0 | DONE | Integration | — | Doc 05 §3 |
| TASK-012 | 0 | Integration | Correlation ID + date/units conventions | Headers; ISO UTC; value+unit | Checklist | TASK-010 | P0 | DONE | Integration | — | Doc 05 §2 |
| TASK-068 | 4 | Integration | Wire farmer auth FE↔BE | OTP → session → API calls | Working path | TASK-033, TASK-051, TASK-011 | P0 | DONE | Integration | — | Doc 05 §7 |
| TASK-069 | 4 | Integration | Wire farm/area/zone FE↔BE | CRUD round-trips | Working setup | TASK-060–066 | P0 | DONE | Integration | — | |
...
| TASK-131 | 10 | Integration | Twin + FarmGraphic E2E | Twin binds graphic | E2E | TASK-041, TASK-055, TASK-069 | P0 | DONE | Integration | — | Doc 05 §7.4 |
| TASK-132 | 10 | Integration | Plan generate E2E | FE plan generate path | E2E | TASK-084, TASK-087, TASK-104 | P0 | DONE | Integration | — | |
| TASK-133 | 10 | Integration | Assistant E2E | Farm-scoped chat | E2E | TASK-105, TASK-107 | P1 | DONE | Integration | — | |
| TASK-134 | 10 | Integration | Green + Experimental E2E | Score + experiment flows | E2E | TASK-121, TASK-122, TASK-110, TASK-111 | P1 | DONE | Integration | — | |
| TASK-135 | 10 | Integration | Admin catalogs/rates E2E | Admin UI ↔ APIs | E2E | TASK-152, TASK-073, TASK-153 | P1 | DONE | Integration | — | |
| TASK-136 | 10 | Integration | Remaining feature-matrix wires | Water/soil/suggestions/alerts | Checklist | TASK-069, TASK-074 | P1 | DONE | Integration | — | Doc 05 §6 |
...
|------------------|----------------|---------|------------------|--------|
| Auth / OTP | `/auth/otp/*` | Auth | TASK-068 | DONE |
| Farm Dashboard | `/farms`, `/twin`, alerts | Farm/Twin | TASK-069, TASK-131 | DONE |
| Farm graphic | `/twin` | Twin | TASK-131 | DONE |
| Production Areas | `.../production-areas` | Farm | TASK-069 | DONE |
| Crop Zones | `.../zones` | Farm | TASK-069 | DONE |
| Digital Twin refresh | `POST .../twin/refresh` | Twin | TASK-136 | DONE |
...
| Crop Planning | `POST .../plan` | Planning+AI | TASK-132 | DONE |
| Yield / Economics | plan + `/economics` | Economics | TASK-132 / TASK-136 | NOT STARTED |
| Nearby farms | `/suggestions` | Nearby | TASK-136 | DONE |
| Experimental | experimental APIs | Experimental | TASK-134 | DONE |
| Green Farm | `/green-score` | Green | TASK-134 | DONE |
| AI Assistant | `/assistant/threads*` | AI | TASK-133 | DONE |
| Admin login | `/admin/auth/login` | AdminAuth | TASK-135 | DONE |
| Admin catalogs/rates | `/admin/*` | Admin | TASK-135 | DONE |

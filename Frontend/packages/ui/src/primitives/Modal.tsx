      ...
      >
        {title && (
          <div className="flex items-center justify-between px-6 py-4 border-b border-[var(--hv-color-neutral-200)]">
            ...
            <button
              onClick={onClose}
              className="min-h-11 min-w-11 inline-flex items-center justify-center rounded hover:bg-[var(--hv-color-neutral-100)] transition-colors"
              aria-label="Close"
            >
        ...
        {footer && (
          <div className="px-6 py-4 border-t border-[var(--hv-color-neutral-200)] flex flex-wrap justify-end gap-3">
            {footer}
          </div>
        )}
      </div>
